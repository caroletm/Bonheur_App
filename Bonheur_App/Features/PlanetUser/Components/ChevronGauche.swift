...
struct ChevronGauche: View {
    ...
    func chevronGauche(width : CGFloat, height : CGFloat, image : ImageResource) -> some View {
    ...
    var body: some View {
        ...
        chevronGauche(width: 44, height: 44, image : .chevronLeft)
    }
}
